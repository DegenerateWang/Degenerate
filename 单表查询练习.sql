...
/*
	...
	4. 找出奖金高于工资60%的员工。
		...
		SELECT * FROM t_employees WHERE 0.6*sal < comm
	...
	6. 找出部门编号为10中所有经理，部门编号为20中所有销售员，还有即不是经理又不是销售员但其工资大或等于20000的所有员工详细资料。
		...
		SELECT * FROM t_employees WHERE deptno = 10 AND job = '经理' OR deptno = 20 AND job = '销售员' OR job != '经理'AND job != '销售员' AND sal >='2000'

	7. 无奖金或奖金低于1000的员工。

		SELECT * FROM t_employees WHERE comm = 0 OR comm IS NULL OR comm < 1000
